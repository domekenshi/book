...
<span class="p-alert">${msg.result}</span>
    ...
    <form action="/Bookshelf/UserInfo" method="post">
        ユーザー名<br> <input type="text" name="name" maxlength='20' value="${user.userName}" required><br>
        ...
        メールアドレス<br> <input type="email" name="mailaddress" value="${user.address}" required><br>
