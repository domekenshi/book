...
<!-- リンクは調整する -->
  ...
  <div class="container-fluid">
    <a class="navbar-brand text-white" href="#">本棚</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active text-white" aria-current="page" href="#">本を追加する</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="#">欲しいものリスト</a>
        </li>
